...
<html lang="fr">
  ...
  <form class="inCo" action="index.php?controle=connexion_E&action=connexion" method="post">
    <h1>SE CONNECTER</h1>
    ...
    <a class="nav-link" href="index.php?controle=inscription&action=inscription"><p class="inscription">Je n'ai pas de compte. Je m'en <span>crée un.</span></p></a>
